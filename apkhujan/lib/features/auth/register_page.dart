...
class _RegisterPageState extends State<RegisterPage> with TickerProviderStateMixin {
  ...
  // Custom controllers for register page to not conflict with login
  ...
  Future<void> _handleRegister() async {
    ...
    // extra username length validation matching login style can be done in auth controller, but form checks are enough.
